...
public abstract class Function {
	...
	public static class FunctionLogarithmic extends FunctionSingleArg {
		...
		@Override public String getDangerFromFuel() { return EnumChatFormatting.YELLOW + I18nUtil.resolveKey("desc.util.function.type.1"); }
	}
	...
	public static class FunctionPassive extends FunctionSingleArg {
		...
		@Override public String getDangerFromFuel() { return EnumChatFormatting.DARK_GREEN + I18nUtil.resolveKey("desc.util.function.type.2"); }
	}
	...
	public static class FunctionSqrt extends FunctionSingleArg {
		...
		@Override public String getDangerFromFuel() { return EnumChatFormatting.YELLOW + I18nUtil.resolveKey("desc.util.function.type.3"); }
	}
	...
	public static class FunctionLinear extends FunctionSingleArg {
		...
		@Override public String getDangerFromFuel() { return EnumChatFormatting.RED + I18nUtil.resolveKey("desc.util.function.type.4"); }
	}
	...
	public static class FunctionQuadratic extends FunctionDoubleArg {
		...
		@Override public String getDangerFromFuel() { return EnumChatFormatting.RED + I18nUtil.resolveKey("desc.util.function.type.5"); }
	}
}
