...
public abstract class RadioTorchRWBase extends RadioTorchBase {
	...
	public void printHook(Pre event, World world, int x, int y, int z) {
		...
		if(te instanceof TileEntityRadioTorchBase) {
			...
			if(radio.channel != null && !radio.channel.isEmpty()) text.add(EnumChatFormatting.AQUA + I18nUtil.format("desc.block.radio.freq", radio.channel));
			text.add(EnumChatFormatting.RED + I18nUtil.format("desc.block.radio.signal", radio.lastState));
