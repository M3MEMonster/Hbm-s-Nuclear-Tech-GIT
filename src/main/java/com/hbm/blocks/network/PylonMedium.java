...
public class PylonMedium extends BlockDummyable implements ITooltipProvider {
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean ext) {
		list.add(I18nUtil.format("desc.block.network.connection_type",I18nUtil.resolveKey("desc.block.network.type.tri")));
		list.add(I18nUtil.format("desc.block.network.connection_range","45m"));
	}
