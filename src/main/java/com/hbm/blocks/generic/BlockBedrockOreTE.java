...
public class BlockBedrockOreTE extends BlockContainer implements ILookOverlay, IBlockMultiPass {
	...
	public void printHook(Pre event, World world, int x, int y, int z) {
		...
		text.add(I18nUtil.format("desc.block.bedrock_ore.tire", ore.tier));

		if(ore.acidRequirement != null) {
			text.add(I18nUtil.format("desc.block.bedrock_ore.require", ore.acidRequirement.fill, ore.acidRequirement.type.getLocalizedName()));
		}
