...
public class BlockAirScrubber extends BlockDummyable implements ILookOverlay, ITooltipProvider {
	...
	public void printHook(Pre event, World world, int x, int y, int z) {
		...
		text.add((scrubber.getPower() <= 200 ? EnumChatFormatting.RED : EnumChatFormatting.GREEN) + I18nUtil.format("desc.block.machine.power", BobMathUtil.getShortNumber(scrubber.getPower())));
