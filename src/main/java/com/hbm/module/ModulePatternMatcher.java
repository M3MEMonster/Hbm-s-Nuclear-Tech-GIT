...
public class ModulePatternMatcher {
	...
	public static String getLabel(String mode) {
		switch(mode) {
		case MODE_EXACT: return EnumChatFormatting.YELLOW + I18nUtil.format("desc.module.pattern_match.type.1");
		case MODE_WILDCARD: return EnumChatFormatting.YELLOW + I18nUtil.format("desc.module.pattern_match.type.2");
		case MODE_BEDROCK: return EnumChatFormatting.YELLOW + I18nUtil.format("desc.module.pattern_match.type.3");
		default: return EnumChatFormatting.YELLOW + I18nUtil.format("desc.module.pattern_match.type.4", mode);
		}
	}
