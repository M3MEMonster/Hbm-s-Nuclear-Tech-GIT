...
public class TileEntityNukeCustom extends TileEntity implements ISidedInventory, IGUIProvider {
	...
	public static enum EnumBombType {
		TNT(I18nUtil.resolveKey("desc.more_info.custom_nuke.type.tnt")),
		NUKE(I18nUtil.resolveKey("desc.more_info.custom_nuke.type.nuke")),
		HYDRO(I18nUtil.resolveKey("desc.more_info.custom_nuke.type.hydro")),
		AMAT(I18nUtil.resolveKey("desc.more_info.custom_nuke.type.amat")),
		DIRTY(I18nUtil.resolveKey("desc.more_info.custom_nuke.type.dirty")),
		SCHRAB(I18nUtil.resolveKey("desc.more_info.custom_nuke.type.schrab")),
		EUPH(I18nUtil.resolveKey("desc.more_info.custom_nuke.type.euph"));
