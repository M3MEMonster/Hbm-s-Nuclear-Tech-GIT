...
public class CommandRadiation extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] args) {
		...
		if(args.length == 1 && "clear".equals(args[0])) {
			...
			sender.addChatMessage(new ChatComponentText(I18nUtil.resolveKey("chat.command.radiation.clear")));
			return;
		}
		...
		if(args.length == 2 && "set".equals(args[0])) {
			...
			sender.addChatMessage(new ChatComponentText(I18nUtil.resolveKey("chat.command.radiation.set")));
			return;
		}
