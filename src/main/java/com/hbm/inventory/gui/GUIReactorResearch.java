...
public class GUIReactorResearch extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		String[] text = new String[] {
			I18nUtil.resolveKey("desc.gui.reactor_research.info1"),
				I18nUtil.resolveKey("desc.gui.reactor_research.info2"),
				I18nUtil.resolveKey("desc.gui.reactor_research.info3"),
				I18nUtil.resolveKey("desc.gui.reactor_research.info4")
		};
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft - 14, guiTop + 23, 16, 16, guiLeft - 6, guiTop + 23 + 16, text);

		String[] text2 = new String[] {
				I18nUtil.resolveKey("desc.gui.reactor_research.info5"),
				I18nUtil.resolveKey("desc.gui.reactor_research.info6")
		};
	...
	protected void drawGuiContainerForegroundLayer(int i, int j) {
		...
		final String[] labels = { I18nUtil.resolveKey("desc.gui.reactor_research.label.flux"), I18nUtil.resolveKey("desc.gui.reactor_research.label.heat"), I18nUtil.resolveKey("desc.gui.reactor_research.label.control") };
