		...
		if(this.mc.thePlayer.inventory.getItemStack() == null) {
			for(int i = 0; i < 9; ++i) {
				...
				if(this.isMouseOverSlot(slot, x, y) && grabber.matcher.modes[i] != null) {
					this.func_146283_a(Arrays.asList(new String[] { EnumChatFormatting.RED + I18nUtil.resolveKey("desc.gui.common.change"), ModulePatternMatcher.getLabel(grabber.matcher.modes[i]) }), x, y - 30);
				}
			}
		}
	}
