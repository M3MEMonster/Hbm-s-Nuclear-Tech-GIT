...
public class GUIMassStorage extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 62, guiTop + 72, 14, 14, mouseX, mouseY, new String[] {I18nUtil.resolveKey("desc.gui.mass_storage.click"), I18nUtil.resolveKey("desc.gui.mass_storage.click") });
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 80, guiTop + 72, 14, 14, mouseX, mouseY, new String[] { I18nUtil.resolveKey("desc.gui.mass_storage.out") });
	}
