...
public class GUISoyuzLauncher extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 43, guiTop + 17, 18, 18, mouseX, mouseY, new String[]{I18nUtil.resolveKey("desc.gui.soyuz_launcher.1")} );
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 43, guiTop + 35, 18, 18, mouseX, mouseY, new String[]{I18nUtil.resolveKey("desc.gui.soyuz_launcher.2")} );
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 133, guiTop + 17, 18, 18, mouseX, mouseY, new String[]{I18nUtil.resolveKey("desc.gui.soyuz_launcher.3")} );
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 133, guiTop + 35, 18, 18, mouseX, mouseY, new String[]{I18nUtil.resolveKey("desc.gui.soyuz_launcher.4")} );
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 88, guiTop + 17, 18, 18, mouseX, mouseY, new String[]{I18nUtil.resolveKey("desc.gui.soyuz_launcher.5")} );
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 88, guiTop + 35, 18, 18, mouseX, mouseY, new String[]{I18nUtil.resolveKey("desc.gui.soyuz_launcher.6")} );
	}
