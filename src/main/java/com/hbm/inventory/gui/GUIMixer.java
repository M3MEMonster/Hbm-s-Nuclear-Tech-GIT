...
public class GUIMixer extends GuiInfoContainer {
	...
	public void drawScreen(int x, int y, float interp) {
		...
		if(recipes != null && recipes.length > 1) {
			...
			label.add(EnumChatFormatting.YELLOW + I18nUtil.resolveKey("desc.gui.mixer.current_recipe", (mixer.recipeIndex + 1), recipes.length));
			...
			label.add(EnumChatFormatting.RED + I18nUtil.format("desc.gui.mixer.click"));
