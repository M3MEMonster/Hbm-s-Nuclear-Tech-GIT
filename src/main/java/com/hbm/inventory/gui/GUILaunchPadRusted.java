...
public class GUILaunchPadRusted extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		drawCustomInfoStat(mouseX, mouseY, guiLeft + 26, guiTop + 36, 16, 16, mouseX, mouseY, EnumChatFormatting.YELLOW + I18nUtil.resolveKey("desc.gui.launch_pad_rust.release"), I18nUtil.resolveKey("desc.gui.launch_pad_rust.lock1"), I18nUtil.resolveKey("desc.gui.launch_pad_rust.lock2"), I18nUtil.resolveKey("desc.gui.launch_pad_rust.damage1"), I18nUtil.resolveKey("desc.gui.launch_pad_rust.damage2"));
	}
