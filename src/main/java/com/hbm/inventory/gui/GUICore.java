...
public class GUICore extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		String[] text = new String[] { I18nUtil.resolveKey("desc.gui.core.restriction", core.field) };
		String[] text1 = new String[] { I18nUtil.resolveKey("desc.gui.core.heat", core.heat) };
