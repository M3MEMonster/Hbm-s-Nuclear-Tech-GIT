...
public class GUIPWR extends GuiInfoContainer {
	...
	public void drawScreen(int x, int y, float interp) {
		...
		this.drawCustomInfoStat(x, y, guiLeft + 115, guiTop + 31, 18, 18, x, y, new String[] { I18nUtil.resolveKey("desc.gui.pwr.core", String.format(Locale.US, "%,d", controller.coreHeat) + " / " + String.format(Locale.US, "%,d", controller.coreHeatCapacity)) });
		this.drawCustomInfoStat(x, y, guiLeft + 151, guiTop + 31, 18, 18, x, y, new String[] { I18nUtil.resolveKey("desc.gui.pwr.hull", String.format(Locale.US, "%,d", controller.hullHeat) + " / " + String.format(Locale.US, "%,d", controller.hullHeatCapacityBase)) });

		this.drawCustomInfoStat(x, y, guiLeft + 52, guiTop + 31, 36, 18, x, y, new String[] { ((int) (controller.progress * 100 / controller.processTime)) + "%" });
		this.drawCustomInfoStat(x, y, guiLeft + 52, guiTop + 53, 54, 4, x, y, I18nUtil.resolveKey("desc.gui.pwr.rod", (100 - (Math.round(controller.rodLevel * 100)/100))));
