...
public class GUISatDock extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		String[] text = new String[] {I18nUtil.resolveKey("desc.gui.sat_dock.info1"),
				I18nUtil.resolveKey("desc.gui.sat_dock.info2"),
				I18nUtil.resolveKey("desc.gui.sat_dock.info3") };
