...
public class GUIRBMKConsole extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 61, guiTop + 70, 10, 10, mouseX, mouseY, new String[]{ I18nUtil.resolveKey("desc.gui.rmbk_console.select_all") } );
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 72, guiTop + 70, 10, 10, mouseX, mouseY, new String[]{ I18nUtil.resolveKey("desc.gui.rmbk_console.deselect_all") } );
		...
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 6, guiTop + 70, 10, 10, mouseX, mouseY, new String[]{ EnumChatFormatting.RED + I18nUtil.resolveKey("desc.gui.rmbk_console.select.red"), EnumChatFormatting.RED + I18nUtil.resolveKey("desc.gui.rmbk_console.assign.red") } );
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 17, guiTop + 70, 10, 10, mouseX, mouseY, new String[]{ EnumChatFormatting.YELLOW + I18nUtil.resolveKey("desc.gui.rmbk_console.select.yellow"), EnumChatFormatting.YELLOW + I18nUtil.resolveKey("desc.gui.rmbk_console.assign.yellow") } );
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 28, guiTop + 70, 10, 10, mouseX, mouseY, new String[]{ EnumChatFormatting.GREEN + I18nUtil.resolveKey("desc.gui.rmbk_console.select.green"), EnumChatFormatting.GREEN + I18nUtil.resolveKey("desc.gui.rmbk_console.assign.green") } );
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 39, guiTop + 70, 10, 10, mouseX, mouseY, new String[]{ EnumChatFormatting.BLUE + I18nUtil.resolveKey("desc.gui.rmbk_console.select.blue"), EnumChatFormatting.BLUE + I18nUtil.resolveKey("desc.gui.rmbk_console.assign.blue") } );
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 50, guiTop + 70, 10, 10, mouseX, mouseY, new String[]{ EnumChatFormatting.LIGHT_PURPLE + I18nUtil.resolveKey("desc.gui.rmbk_console.select.purple"), EnumChatFormatting.LIGHT_PURPLE + I18nUtil.resolveKey("desc.gui.rmbk_console.assign.purple") } );
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 70, guiTop + 82, 12, 12, mouseX, mouseY, new String[]{ I18nUtil.resolveKey("desc.gui.rmbk_console.cycle") } );
	}
