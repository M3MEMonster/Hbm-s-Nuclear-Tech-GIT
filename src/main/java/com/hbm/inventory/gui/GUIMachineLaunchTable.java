...
public class GUIMachineLaunchTable extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		this.drawCustomInfo(this, mouseX, mouseY, guiLeft + 152, guiTop + 88 - 52, 16, 52, new String[] { I18nUtil.resolveKey("desc.gui.launch_table.fuel", launcher.solid) });
		this.drawElectricityInfo(this, mouseX, mouseY, guiLeft + 134, guiTop + 113, 34, 6, launcher.power, launcher.maxPower);
		this.drawCustomInfo(this, mouseX, mouseY, guiLeft + 7, guiTop + 98, 18, 18, new String[] { I18nUtil.resolveKey("desc.gui.launch_table.size1") });
		this.drawCustomInfo(this, mouseX, mouseY, guiLeft + 25, guiTop + 98, 18, 18, new String[] { I18nUtil.resolveKey("desc.gui.launch_table.size2") });
		this.drawCustomInfo(this, mouseX, mouseY, guiLeft + 43, guiTop + 98, 18, 18, new String[] { I18nUtil.resolveKey("desc.gui.launch_table.size3") });

		String[] text = new String[] { I18nUtil.resolveKey("desc.gui.launch_table.info1"), I18nUtil.resolveKey("desc.gui.launch_table.info2"), I18nUtil.resolveKey("desc.gui.launch_table.info3") };
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft - 16, guiTop + 36, 16, 16, guiLeft - 8, guiTop + 36 + 16, text);

		String[] text1 = new String[] { I18nUtil.resolveKey("desc.gui.compact_launcher.detonator") };
