...
public class GUIITER extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		String text = I18nUtil.resolveKey("desc.gui.iter.magnet", ((iter.isOn && iter.power >= iter.powerReq) ? I18nUtil.resolveKey("desc.gui.iter.magnet.on") : I18nUtil.resolveKey("desc.gui.iter.magnet.off")));
