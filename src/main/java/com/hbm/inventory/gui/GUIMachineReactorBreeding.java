...
public class GUIMachineReactorBreeding extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		String[] text = new String[] {
			I18nUtil.resolveKey("desc.gui.reactor_breeding.info1"),
				I18nUtil.resolveKey("desc.gui.reactor_breeding.info2"),
				I18nUtil.resolveKey("desc.gui.reactor_breeding.info3")
		};
