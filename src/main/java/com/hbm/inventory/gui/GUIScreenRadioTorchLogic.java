...
public class GUIScreenRadioTorchLogic extends GuiScreen {
	...
	private void drawGuiContainerForegroundLayer(int x, int y) {
		...
		if(guiLeft + 137 <= x && guiLeft + 137 + 18 > x && guiTop + 17 < y && guiTop + 17 + 18 >= y) {
			func_146283_a(Arrays.asList(new String[] { logic.descending ? I18nUtil.resolveKey("desc.gui.screen_radio_torch_logic.order.des") : I18nUtil.resolveKey("desc.gui.screen_radio_torch_logic.order.asc") }), x, y);
		}
		if(guiLeft + 173 <= x && guiLeft + 173 + 18 > x && guiTop + 17 < y && guiTop + 17 + 18 >= y) {
			func_146283_a(Arrays.asList(new String[] { logic.polling ? I18nUtil.resolveKey("desc.gui.screen_radio.polling") : I18nUtil.resolveKey("desc.gui.screen_radio.change") }), x, y);
		}
