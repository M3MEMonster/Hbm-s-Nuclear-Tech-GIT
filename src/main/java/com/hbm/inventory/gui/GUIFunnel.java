...
public class GUIFunnel extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 159, guiTop + 73, 10, 10, mouseX, mouseY, I18nUtil.resolveKey("desc.gui.funnel.mode", (funnel.mode == funnel.MODE_3x3 ? I18nUtil.resolveKey("desc.gui.funnel.mode.3") : funnel.mode == funnel.MODE_2x2 ? I18nUtil.resolveKey("desc.gui.funnel.mode.2") : I18nUtil.resolveKey("desc.gui.funnel.mode.32"))));
	}
