...
public class GUIScreenRecipeSelector extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		if(guiLeft + 152 <= mouseX && guiLeft + 152 + 16 > mouseX && guiTop + 90 < mouseY && guiTop + 90 + 16 >= mouseY) {
			this.drawCreativeTabHoveringText(EnumChatFormatting.YELLOW + I18nUtil.resolveKey("desc.gui.screen_recipe_selector.close"), mouseX, mouseY);
		}

		if(guiLeft + 134 <= mouseX && guiLeft + 134 + 16 > mouseX && guiTop + 108 < mouseY && guiTop + 108 + 16 >= mouseY) {
			this.drawCreativeTabHoveringText(EnumChatFormatting.YELLOW + I18nUtil.resolveKey("desc.gui.screen_recipe_selector.clear"), mouseX, mouseY);
		}

		if(guiLeft + 8 <= mouseX && guiLeft + 8 + 16 > mouseX && guiTop + 108 < mouseY && guiTop + 108 + 16 >= mouseY) {
			this.drawCreativeTabHoveringText(EnumChatFormatting.ITALIC + I18nUtil.resolveKey("desc.gui.screen_recipe_selector.focus"), mouseX, mouseY);
		}
	}
