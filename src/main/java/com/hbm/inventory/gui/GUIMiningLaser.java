...
public class GUIMiningLaser extends GuiInfoContainer {
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		String[] text = new String[] {I18nUtil.resolveKey("desc.gui.mining_laser.upgrade1"),
				I18nUtil.resolveKey("desc.gui.mining_laser.upgrade2"),
				I18nUtil.resolveKey("desc.gui.mining_laser.upgrade3"),
				I18nUtil.resolveKey("desc.gui.mining_laser.upgrade4"),
				I18nUtil.resolveKey("desc.gui.mining_laser.upgrade5"),
				I18nUtil.resolveKey("desc.gui.mining_laser.upgrade6"),
				I18nUtil.resolveKey("desc.gui.mining_laser.upgrade7"),
				I18nUtil.resolveKey("desc.gui.mining_laser.upgrade8"),
				I18nUtil.resolveKey("desc.gui.mining_laser.upgrade9"),
				I18nUtil.resolveKey("desc.gui.mining_laser.upgrade10")};
