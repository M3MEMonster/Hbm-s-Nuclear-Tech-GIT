...
public class FT_Corrosive extends FluidTrait {
	...
	public void addInfo(List<String> info) {
		...
		if(isHighlyCorrosive())
			info.add(EnumChatFormatting.GOLD + I18nUtil.resolveKey("desc.fluid.corrosive.high.trait"));
		else
			info.add(EnumChatFormatting.YELLOW + I18nUtil.resolveKey("desc.fluid.corrosive.normal.trait"));
	}
