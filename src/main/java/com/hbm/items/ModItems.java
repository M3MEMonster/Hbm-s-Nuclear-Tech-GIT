...
public class ModItems {
	...
	public static void initializeItem() {
		...
		rbmk_pellet_ueu = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_ueu")).setUnlocalizedName("rbmk_pellet_ueu").setTextureName(RefStrings.MODID + ":rbmk_pellet_ueu");
		rbmk_pellet_meu = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_meu")).setUnlocalizedName("rbmk_pellet_meu").setTextureName(RefStrings.MODID + ":rbmk_pellet_meu");
		rbmk_pellet_heu233 = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_heu233")).setUnlocalizedName("rbmk_pellet_heu233").setTextureName(RefStrings.MODID + ":rbmk_pellet_heu233");
		rbmk_pellet_heu235 = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_heu235")).setUnlocalizedName("rbmk_pellet_heu235").setTextureName(RefStrings.MODID + ":rbmk_pellet_heu235");
		rbmk_pellet_thmeu = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_thmeu")).setUnlocalizedName("rbmk_pellet_thmeu").setTextureName(RefStrings.MODID + ":rbmk_pellet_thmeu");
		rbmk_pellet_lep = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_lep")).setUnlocalizedName("rbmk_pellet_lep").setTextureName(RefStrings.MODID + ":rbmk_pellet_lep");
		rbmk_pellet_mep = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_mep")).setUnlocalizedName("rbmk_pellet_mep").setTextureName(RefStrings.MODID + ":rbmk_pellet_mep");
		rbmk_pellet_hep239 = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_hep239")).setUnlocalizedName("rbmk_pellet_hep239").setTextureName(RefStrings.MODID + ":rbmk_pellet_hep239");
		rbmk_pellet_hep241 = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_hep241")).setUnlocalizedName("rbmk_pellet_hep241").setTextureName(RefStrings.MODID + ":rbmk_pellet_hep241");
		rbmk_pellet_lea = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_lea")).setUnlocalizedName("rbmk_pellet_lea").setTextureName(RefStrings.MODID + ":rbmk_pellet_lea");
		rbmk_pellet_mea = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_mea")).setUnlocalizedName("rbmk_pellet_mea").setTextureName(RefStrings.MODID + ":rbmk_pellet_mea");
		rbmk_pellet_hea241 = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_hea241")).setUnlocalizedName("rbmk_pellet_hea241").setTextureName(RefStrings.MODID + ":rbmk_pellet_hea241");
		rbmk_pellet_hea242 = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_hea242")).setUnlocalizedName("rbmk_pellet_hea242").setTextureName(RefStrings.MODID + ":rbmk_pellet_hea242");
		rbmk_pellet_bk247 = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_bk247")).setUnlocalizedName("rbmk_pellet_bk247").setTextureName(RefStrings.MODID + ":rbmk_pellet_bk247");
		rbmk_pellet_men = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_men")).setUnlocalizedName("rbmk_pellet_men").setTextureName(RefStrings.MODID + ":rbmk_pellet_men");
		rbmk_pellet_hen = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_hen")).setUnlocalizedName("rbmk_pellet_hen").setTextureName(RefStrings.MODID + ":rbmk_pellet_hen");
		rbmk_pellet_mox = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_mox")).setUnlocalizedName("rbmk_pellet_mox").setTextureName(RefStrings.MODID + ":rbmk_pellet_mox");
		rbmk_pellet_les = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_les")).setUnlocalizedName("rbmk_pellet_les").setTextureName(RefStrings.MODID + ":rbmk_pellet_les");
		rbmk_pellet_mes = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_mes")).setUnlocalizedName("rbmk_pellet_mes").setTextureName(RefStrings.MODID + ":rbmk_pellet_mes");
		rbmk_pellet_hes = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_hes")).setUnlocalizedName("rbmk_pellet_hes").setTextureName(RefStrings.MODID + ":rbmk_pellet_hes");
		rbmk_pellet_leaus = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_leaus")).setUnlocalizedName("rbmk_pellet_leaus").setTextureName(RefStrings.MODID + ":rbmk_pellet_leaus");
		rbmk_pellet_heaus = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_heaus")).setUnlocalizedName("rbmk_pellet_heaus").setTextureName(RefStrings.MODID + ":rbmk_pellet_heaus");
		rbmk_pellet_po210be = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_po210be")).disableXenon().setUnlocalizedName("rbmk_pellet_po210be").setTextureName(RefStrings.MODID + ":rbmk_pellet_po210be");
		rbmk_pellet_ra226be = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_ra226be")).disableXenon().setUnlocalizedName("rbmk_pellet_ra226be").setTextureName(RefStrings.MODID + ":rbmk_pellet_ra226be");
		rbmk_pellet_pu238be = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_pu238be")).setUnlocalizedName("rbmk_pellet_pu238be").setTextureName(RefStrings.MODID + ":rbmk_pellet_pu238be");
		rbmk_pellet_balefire_gold = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_balefire_gold")).disableXenon().setUnlocalizedName("rbmk_pellet_balefire_gold").setTextureName(RefStrings.MODID + ":rbmk_pellet_balefire_gold");
		rbmk_pellet_flashlead = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_flashlead")).disableXenon().setUnlocalizedName("rbmk_pellet_flashlead").setTextureName(RefStrings.MODID + ":rbmk_pellet_flashlead");
		rbmk_pellet_balefire = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_balefire")).disableXenon().setUnlocalizedName("rbmk_pellet_balefire").setTextureName(RefStrings.MODID + ":rbmk_pellet_balefire");
		rbmk_pellet_zfb_bismuth = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_zfb_bismuth")).setUnlocalizedName("rbmk_pellet_zfb_bismuth").setTextureName(RefStrings.MODID + ":rbmk_pellet_zfb_bismuth");
		rbmk_pellet_zfb_pu241 = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_zfb_pu241")).setUnlocalizedName("rbmk_pellet_zfb_pu241").setTextureName(RefStrings.MODID + ":rbmk_pellet_zfb_pu241");
		rbmk_pellet_zfb_am_mix = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_zfb_am_mix")).setUnlocalizedName("rbmk_pellet_zfb_am_mix").setTextureName(RefStrings.MODID + ":rbmk_pellet_zfb_am_mix");
		rbmk_pellet_drx = (ItemRBMKPellet) new ItemRBMKPellet(EnumChatFormatting.OBFUSCATED + I18nUtil.resolveKey("desc.item.rbmk_pellet_drx")).setUnlocalizedName("rbmk_pellet_drx").setTextureName(RefStrings.MODID + ":rbmk_pellet_drx");
		rbmk_pellet_lecm = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_lecm")).setUnlocalizedName("rbmk_pellet_lecm").setTextureName(RefStrings.MODID + ":rbmk_pellet_lecm");
		rbmk_pellet_mecm = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_mecm")).setUnlocalizedName("rbmk_pellet_mecm").setTextureName(RefStrings.MODID + ":rbmk_pellet_mecm");
		rbmk_pellet_hecm = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_hecm")).setUnlocalizedName("rbmk_pellet_hecm").setTextureName(RefStrings.MODID + ":rbmk_pellet_hecm");
		rbmk_pellet_lecf = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_lecf")).setUnlocalizedName("rbmk_pellet_lecf").setTextureName(RefStrings.MODID + ":rbmk_pellet_lecf");
		rbmk_pellet_mecf = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_mecf")).setUnlocalizedName("rbmk_pellet_mecf").setTextureName(RefStrings.MODID + ":rbmk_pellet_mecf");
		rbmk_pellet_hecf = (ItemRBMKPellet) new ItemRBMKPellet(I18nUtil.resolveKey("desc.item.rbmk_pellet_hecf")).setUnlocalizedName("rbmk_pellet_hecf").setTextureName(RefStrings.MODID + ":rbmk_pellet_hecf");
		...
		mp_thruster_15_balefire_large_rad = new ItemCustomMissilePart().makeThruster(FuelType.BALEFIRE, 1F, 7.5F, PartSize.SIZE_15, 1_200_000, 2400, 666).setAuthor(I18nUtil.resolveKey("desc.item.mp_thruster_15_balefire_large_rad.author")).setHealth(35F).setRarity(Rarity.UNCOMMON).setUnlocalizedName("mp_thruster_15_balefire_large_rad");
		...
		mp_thruster_20_solid = new ItemCustomMissilePart().makeThruster(FuelType.SOLID, 1F, 100F, PartSize.SIZE_20, 1_400_000, 2400, 195).setHealth(35F).setWittyText(I18nUtil.resolveKey("desc.item.mp_thruster_20_solid.wittytext")).setUnlocalizedName("mp_thruster_20_solid");
		...
		mp_thruster_20_solid_multier = new ItemCustomMissilePart().makeThruster(FuelType.SOLID, 1F, 100F, PartSize.SIZE_20, 2_320_000, 4000, 195).setHealth(35F).setWittyText(I18nUtil.resolveKey("desc.item.mp_thruster_20_solid_multier.wittytext")).setUnlocalizedName("mp_thruster_20_solid_multier");
		...
		mp_stability_10_space = new ItemCustomMissilePart().makeStability(0.35F, PartSize.SIZE_10).setHealth(5F).setRarity(Rarity.COMMON).setWittyText(I18nUtil.resolveKey("desc.item.mp_stability_10_space.wittytext")).setMaxStackSize(1).setUnlocalizedName("mp_stability_10_space");
		...
		mp_stability_15_soyuz = new ItemCustomMissilePart().makeStability(0.25F, PartSize.SIZE_15).setHealth(15F).setRarity(Rarity.COMMON).setWittyText(I18nUtil.resolveKey("desc.item.mp_stability_15_soyuz.wittytext")).setMaxStackSize(1).setUnlocalizedName("mp_stability_15_soyuz");
		...
		mp_fuselage_10_kerosene = new ItemCustomMissilePart().makeFuselage(FuelType.KEROSENE, 2500, 1000, PartSize.SIZE_10, PartSize.SIZE_10).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_kerosene.author")).setHealth(20F).setUnlocalizedName("mp_fuselage_10_kerosene");
		mp_fuselage_10_kerosene_camo =			((ItemCustomMissilePart) mp_fuselage_10_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_kerosene_camo.title")).setUnlocalizedName("mp_fuselage_10_kerosene_camo");
		mp_fuselage_10_kerosene_desert = 		((ItemCustomMissilePart) mp_fuselage_10_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_kerosene_desert.title")).setUnlocalizedName("mp_fuselage_10_kerosene_desert");
		mp_fuselage_10_kerosene_sky = 			((ItemCustomMissilePart) mp_fuselage_10_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_kerosene_sky.title")).setUnlocalizedName("mp_fuselage_10_kerosene_sky");
		mp_fuselage_10_kerosene_flames = 		((ItemCustomMissilePart) mp_fuselage_10_kerosene).copy().setRarity(Rarity.UNCOMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_kerosene_flames.title")).setUnlocalizedName("mp_fuselage_10_kerosene_flames");
		mp_fuselage_10_kerosene_insulation = 	((ItemCustomMissilePart) mp_fuselage_10_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_kerosene_insulation.title")).setHealth(25F).setUnlocalizedName("mp_fuselage_10_kerosene_insulation");
		mp_fuselage_10_kerosene_sleek = 		((ItemCustomMissilePart) mp_fuselage_10_kerosene).copy().setRarity(Rarity.RARE).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_kerosene_sleek.title")).setHealth(35F).setUnlocalizedName("mp_fuselage_10_kerosene_sleek");
		mp_fuselage_10_kerosene_metal = 		((ItemCustomMissilePart) mp_fuselage_10_kerosene).copy().setRarity(Rarity.UNCOMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_kerosene_metal.title")).setHealth(30F).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_kerosene_metal.author")).setUnlocalizedName("mp_fuselage_10_kerosene_metal");
		mp_fuselage_10_kerosene_taint =			((ItemCustomMissilePart) mp_fuselage_10_kerosene).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_kerosene_taint.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_kerosene_taint.title")).setUnlocalizedName("mp_fuselage_10_kerosene_taint");
		...
		mp_fuselage_10_solid_flames = 		((ItemCustomMissilePart) mp_fuselage_10_solid).copy().setRarity(Rarity.UNCOMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_flames.title")).setUnlocalizedName("mp_fuselage_10_solid_flames");
		mp_fuselage_10_solid_insulation = 	((ItemCustomMissilePart) mp_fuselage_10_solid).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_insulation.title")).setHealth(30F).setUnlocalizedName("mp_fuselage_10_solid_insulation");
		mp_fuselage_10_solid_sleek = 		((ItemCustomMissilePart) mp_fuselage_10_solid).copy().setRarity(Rarity.RARE).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_sleek.title")).setHealth(35F).setUnlocalizedName("mp_fuselage_10_solid_sleek");
		mp_fuselage_10_solid_soviet_glory = ((ItemCustomMissilePart) mp_fuselage_10_solid).copy().setRarity(Rarity.EPIC).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_soviet_glory.author")).setHealth(35F).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_soviet_glory.title")).setUnlocalizedName("mp_fuselage_10_solid_soviet_glory");
		mp_fuselage_10_solid_cathedral = 	((ItemCustomMissilePart) mp_fuselage_10_solid).copy().setRarity(Rarity.RARE).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_cathedral.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_cathedral.title")).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_cathedral.wittytext")).setUnlocalizedName("mp_fuselage_10_solid_cathedral");
		mp_fuselage_10_solid_moonlit = 		((ItemCustomMissilePart) mp_fuselage_10_solid).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_moonlit.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_moonlit.title")).setUnlocalizedName("mp_fuselage_10_solid_moonlit");
		mp_fuselage_10_solid_battery = 		((ItemCustomMissilePart) mp_fuselage_10_solid).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_battery.author")).setHealth(30F).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_battery.title")).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_battery.wittytext")).setUnlocalizedName("mp_fuselage_10_solid_battery");
		mp_fuselage_10_solid_duracell = 	((ItemCustomMissilePart) mp_fuselage_10_solid).copy().setRarity(Rarity.RARE).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_duracell.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_duracell.title")).setHealth(30F).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_10_solid_duracell.wittytext")).setUnlocalizedName("mp_fuselage_10_solid_duracell");
		...
		mp_fuselage_10_xenon_bhole = 	((ItemCustomMissilePart) mp_fuselage_10_xenon).copy().setRarity(Rarity.RARE).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_xenon_bhole.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_xenon_bhole.title")).setUnlocalizedName("mp_fuselage_10_xenon_bhole");
		...
		mp_fuselage_10_long_kerosene = new ItemCustomMissilePart().makeFuselage(FuelType.KEROSENE, 5000, 1000, PartSize.SIZE_10, PartSize.SIZE_10).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene.author")).setHealth(30F).setUnlocalizedName("mp_fuselage_10_long_kerosene");
		mp_fuselage_10_long_kerosene_camo = 		((ItemCustomMissilePart) mp_fuselage_10_long_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_camo.title")).setUnlocalizedName("mp_fuselage_10_long_kerosene_camo");
		mp_fuselage_10_long_kerosene_desert = 		((ItemCustomMissilePart) mp_fuselage_10_long_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_desert.title")).setUnlocalizedName("mp_fuselage_10_long_kerosene_desert");
		mp_fuselage_10_long_kerosene_sky = 			((ItemCustomMissilePart) mp_fuselage_10_long_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_sky.title")).setUnlocalizedName("mp_fuselage_10_long_kerosene_sky");
		mp_fuselage_10_long_kerosene_flames = 		((ItemCustomMissilePart) mp_fuselage_10_long_kerosene).copy().setRarity(Rarity.UNCOMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_flames.title")).setUnlocalizedName("mp_fuselage_10_long_kerosene_flames");
		mp_fuselage_10_long_kerosene_insulation = 	((ItemCustomMissilePart) mp_fuselage_10_long_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_insulation.title")).setHealth(35F).setUnlocalizedName("mp_fuselage_10_long_kerosene_insulation");
		mp_fuselage_10_long_kerosene_sleek =		((ItemCustomMissilePart) mp_fuselage_10_long_kerosene).copy().setRarity(Rarity.RARE).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_sleek.title")).setHealth(40F).setUnlocalizedName("mp_fuselage_10_long_kerosene_sleek");
		mp_fuselage_10_long_kerosene_metal = 		((ItemCustomMissilePart) mp_fuselage_10_long_kerosene).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_metal.author")).setHealth(35F).setUnlocalizedName("mp_fuselage_10_long_kerosene_metal");
		mp_fuselage_10_long_kerosene_dash = 		((ItemCustomMissilePart) mp_fuselage_10_long_kerosene).copy().setRarity(Rarity.EPIC).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_dash.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_dash.title")).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_dash.wittytext")).setCreativeTab(null).setUnlocalizedName("mp_fuselage_10_long_kerosene_dash");
		mp_fuselage_10_long_kerosene_taint = 		((ItemCustomMissilePart) mp_fuselage_10_long_kerosene).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_taint.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_taint.title")).setUnlocalizedName("mp_fuselage_10_long_kerosene_taint");
		mp_fuselage_10_long_kerosene_vap = 			((ItemCustomMissilePart) mp_fuselage_10_long_kerosene).copy().setRarity(Rarity.EPIC).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_vap.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_vap.title")).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_kerosene_vap.wittytext")).setUnlocalizedName("mp_fuselage_10_long_kerosene_vap");
		...
		mp_fuselage_10_long_solid_flames = 			((ItemCustomMissilePart) mp_fuselage_10_long_solid).copy().setRarity(Rarity.UNCOMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_solid_flames.title")).setUnlocalizedName("mp_fuselage_10_long_solid_flames");
		mp_fuselage_10_long_solid_insulation = 		((ItemCustomMissilePart) mp_fuselage_10_long_solid).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_solid_insulation.title")).setHealth(40F).setUnlocalizedName("mp_fuselage_10_long_solid_insulation");
		mp_fuselage_10_long_solid_sleek = 			((ItemCustomMissilePart) mp_fuselage_10_long_solid).copy().setRarity(Rarity.RARE).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_solid_sleek.title")).setHealth(45F).setUnlocalizedName("mp_fuselage_10_long_solid_sleek");
		mp_fuselage_10_long_solid_soviet_glory = 	((ItemCustomMissilePart) mp_fuselage_10_long_solid).copy().setRarity(Rarity.EPIC).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_solid_soviet_glory.author")).setHealth(45F).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_solid_soviet_glory.title")).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_solid_soviet_glory.wittytext")).setUnlocalizedName("mp_fuselage_10_long_solid_soviet_glory");
		mp_fuselage_10_long_solid_bullet = 			((ItemCustomMissilePart) mp_fuselage_10_long_solid).copy().setRarity(Rarity.COMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_solid_bullet.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_solid_bullet.title")).setUnlocalizedName("mp_fuselage_10_long_solid_bullet");
		mp_fuselage_10_long_solid_silvermoonlight = ((ItemCustomMissilePart) mp_fuselage_10_long_solid).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_solid_silvermoonlight.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_10_long_solid_silvermoonlight.title")).setUnlocalizedName("mp_fuselage_10_long_solid_silvermoonlight");
		...
		mp_fuselage_15_kerosene = new ItemCustomMissilePart().makeFuselage(FuelType.KEROSENE, 15000, 1000, PartSize.SIZE_15, PartSize.SIZE_15).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene.author")).setHealth(50F).setUnlocalizedName("mp_fuselage_15_kerosene");
		mp_fuselage_15_kerosene_camo = 			((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_camo.title")).setUnlocalizedName("mp_fuselage_15_kerosene_camo");
		mp_fuselage_15_kerosene_desert = 		((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_desert.title")).setUnlocalizedName("mp_fuselage_15_kerosene_desert");
		mp_fuselage_15_kerosene_sky = 			((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_sky.title")).setUnlocalizedName("mp_fuselage_15_kerosene_sky");
		mp_fuselage_15_kerosene_insulation = 	((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_insulation.title")).setHealth(55F).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_insulation.wittytext")).setUnlocalizedName("mp_fuselage_15_kerosene_insulation");
		mp_fuselage_15_kerosene_metal = 		((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_metal.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_metal.title")).setHealth(60F).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_metal.wittytext")).setUnlocalizedName("mp_fuselage_15_kerosene_metal");
		mp_fuselage_15_kerosene_decorated = 	((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_decorated.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_decorated.title")).setHealth(60F).setUnlocalizedName("mp_fuselage_15_kerosene_decorated");
		mp_fuselage_15_kerosene_steampunk = 	((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.RARE).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_steampunk.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_steampunk.title")).setHealth(60F).setUnlocalizedName("mp_fuselage_15_kerosene_steampunk");
		mp_fuselage_15_kerosene_polite = 		((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.LEGENDARY).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_polite.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_polite.title")).setHealth(60F).setUnlocalizedName("mp_fuselage_15_kerosene_polite");
		mp_fuselage_15_kerosene_blackjack = 	((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.LEGENDARY).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_blackjack.title")).setHealth(100F).setUnlocalizedName("mp_fuselage_15_kerosene_blackjack");
		mp_fuselage_15_kerosene_lambda = 		((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.RARE).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_lambda.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_lambda.title")).setHealth(75F).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_lambda.wittytext")).setUnlocalizedName("mp_fuselage_15_kerosene_lambda");
		mp_fuselage_15_kerosene_minuteman = 	((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_minuteman.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_minuteman.title")).setUnlocalizedName("mp_fuselage_15_kerosene_minuteman");
		mp_fuselage_15_kerosene_pip = 			((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.EPIC).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_pip.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_pip.title")).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_pip.wittytext")).setCreativeTab(null).setUnlocalizedName("mp_fuselage_15_kerosene_pip");
		mp_fuselage_15_kerosene_taint = 		((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_taint.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_taint.title")).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_taint.wittytext")).setUnlocalizedName("mp_fuselage_15_kerosene_taint");
		mp_fuselage_15_kerosene_yuck = 			((ItemCustomMissilePart) mp_fuselage_15_kerosene).copy().setRarity(Rarity.EPIC).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_yuck.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_yuck.title")).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_15_kerosene_yuck.wittytext")).setHealth(60F).setUnlocalizedName("mp_fuselage_15_kerosene_yuck");
		...
		mp_fuselage_15_solid_insulation = 		((ItemCustomMissilePart) mp_fuselage_15_solid).copy().setRarity(Rarity.COMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_insulation.title")).setHealth(65F).setUnlocalizedName("mp_fuselage_15_solid_insulation");
		mp_fuselage_15_solid_desh = 			((ItemCustomMissilePart) mp_fuselage_15_solid).copy().setRarity(Rarity.RARE).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_desh.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_desh.title")).setHealth(80F).setUnlocalizedName("mp_fuselage_15_solid_desh");
		mp_fuselage_15_solid_soviet_glory = 	((ItemCustomMissilePart) mp_fuselage_15_solid).copy().setRarity(Rarity.RARE).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_soviet_glory.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_soviet_glory.title")).setHealth(70F).setUnlocalizedName("mp_fuselage_15_solid_soviet_glory");
		mp_fuselage_15_solid_soviet_stank = 	((ItemCustomMissilePart) mp_fuselage_15_solid).copy().setRarity(Rarity.EPIC).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_soviet_stank.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_soviet_stank.title")).setHealth(15F).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_soviet_stank.wittytext")).setUnlocalizedName("mp_fuselage_15_solid_soviet_stank");
		mp_fuselage_15_solid_faust = 			((ItemCustomMissilePart) mp_fuselage_15_solid).copy().setRarity(Rarity.LEGENDARY).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_faust.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_faust.title")).setHealth(250F).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_faust.wittytext")).setUnlocalizedName("mp_fuselage_15_solid_faust");
		mp_fuselage_15_solid_silvermoonlight = 	((ItemCustomMissilePart) mp_fuselage_15_solid).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_silvermoonlight.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_silvermoonlight.title")).setUnlocalizedName("mp_fuselage_15_solid_silvermoonlight");
		mp_fuselage_15_solid_snowy = 			((ItemCustomMissilePart) mp_fuselage_15_solid).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_snowy.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_snowy.title")).setUnlocalizedName("mp_fuselage_15_solid_snowy");
		mp_fuselage_15_solid_panorama = 		((ItemCustomMissilePart) mp_fuselage_15_solid).copy().setRarity(Rarity.RARE).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_panorama.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_panorama.title")).setUnlocalizedName("mp_fuselage_15_solid_panorama");
		mp_fuselage_15_solid_roses = 			((ItemCustomMissilePart) mp_fuselage_15_solid).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_roses.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_roses.title")).setUnlocalizedName("mp_fuselage_15_solid_roses");
		mp_fuselage_15_solid_mimi = 			((ItemCustomMissilePart) mp_fuselage_15_solid).copy().setRarity(Rarity.RARE).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_solid_mimi.title")).setUnlocalizedName("mp_fuselage_15_solid_mimi");
		...
		mp_fuselage_15_hydrogen_cathedral = ((ItemCustomMissilePart) mp_fuselage_15_hydrogen).copy().setRarity(Rarity.UNCOMMON).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_hydrogen_cathedral.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_hydrogen_cathedral.title")).setUnlocalizedName("mp_fuselage_15_hydrogen_cathedral");
		...
		mp_fuselage_15_20_kerosene = new ItemCustomMissilePart().makeFuselage(FuelType.KEROSENE, 20000, 1000, PartSize.SIZE_15, PartSize.SIZE_20).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_20_kerosene.author")).setHealth(70F).setUnlocalizedName("mp_fuselage_15_20_kerosene").setCreativeTab(MainRegistry.missileTab).setTextureName(RefStrings.MODID + ":mp_fuselage");
		mp_fuselage_15_20_kerosene_magnusson = ((ItemCustomMissilePart)mp_fuselage_15_20_kerosene).copy().setRarity(Rarity.RARE).setAuthor(I18nUtil.resolveKey("desc.item.mp_fuselage_15_20_kerosene_magnusson.author")).setTitle(I18nUtil.resolveKey("desc.item.mp_fuselage_15_20_kerosene_magnusson.title")).setWittyText(I18nUtil.resolveKey("desc.item.mp_fuselage_15_20_kerosene_magnusson.wittytext")).setUnlocalizedName("mp_fuselage_15_20_kerosene_magnusson");
		...
		mp_warhead_10_nuclear = new ItemCustomMissilePart().makeWarhead(WarheadType.NUCLEAR, 35F, 1500, PartSize.SIZE_10).setTitle(I18nUtil.resolveKey("desc.item.mp_warhead_10_nuclear.title")).setHealth(10F).setUnlocalizedName("mp_warhead_10_nuclear").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":mp_warhead");
		mp_warhead_10_nuclear_large = new ItemCustomMissilePart().makeWarhead(WarheadType.NUCLEAR, 75F, 2500, PartSize.SIZE_10).setTitle(I18nUtil.resolveKey("desc.item.mp_warhead_10_nuclear_large.title")).setHealth(15F).setUnlocalizedName("mp_warhead_10_nuclear_large").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":mp_warhead");
		mp_warhead_10_taint = new ItemCustomMissilePart().makeWarhead(WarheadType.TAINT, 15F, 1500, PartSize.SIZE_10).setHealth(20F).setRarity(Rarity.UNCOMMON).setWittyText(I18nUtil.resolveKey("desc.item.mp_warhead_10_taint.wittytext")).setUnlocalizedName("mp_warhead_10_taint").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":mp_warhead");
		...
		mp_warhead_15_nuclear = new ItemCustomMissilePart().makeWarhead(WarheadType.NUCLEAR, 125F, 5000, PartSize.SIZE_15).setTitle(I18nUtil.resolveKey("desc.item.mp_warhead_15_nuclear.title")).setHealth(15F).setUnlocalizedName("mp_warhead_15_nuclear").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":mp_warhead");
		mp_warhead_15_nuclear_shark = ((ItemCustomMissilePart) mp_warhead_15_nuclear).copy().setRarity(Rarity.UNCOMMON).setTitle(I18nUtil.resolveKey("desc.item.mp_warhead_15_nuclear_shark.title")).setWittyText(I18nUtil.resolveKey("desc.item.mp_warhead_15_nuclear_shark.wittytext")).setUnlocalizedName("mp_warhead_15_nuclear_shark");
		mp_warhead_15_nuclear_mimi = ((ItemCustomMissilePart) mp_warhead_15_nuclear).copy().setRarity(Rarity.RARE).setTitle(I18nUtil.resolveKey("desc.item.mp_warhead_15_nuclear_mimi.title")).setUnlocalizedName("mp_warhead_15_nuclear_mimi");
		mp_warhead_15_boxcar = new ItemCustomMissilePart().makeWarhead(WarheadType.TX, 250F, 7500, PartSize.SIZE_15).setWittyText(I18nUtil.resolveKey("desc.item.mp_warhead_15_boxcar.wittytext")).setHealth(35F).setRarity(Rarity.LEGENDARY).setUnlocalizedName("mp_warhead_15_boxcar").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":mp_warhead");
		mp_warhead_15_n2 = new ItemCustomMissilePart().makeWarhead(WarheadType.N2, 100F, 5000, PartSize.SIZE_15).setWittyText(I18nUtil.resolveKey("desc.item.mp_warhead_15_n2.wittytext")).setHealth(20F).setRarity(Rarity.RARE).setUnlocalizedName("mp_warhead_15_n2").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":mp_warhead");
		mp_warhead_15_balefire = new ItemCustomMissilePart().makeWarhead(WarheadType.BALEFIRE, 100F, 7500, PartSize.SIZE_15).setRarity(Rarity.LEGENDARY).setAuthor(I18nUtil.resolveKey("desc.item.mp_warhead_15_balefire.author")).setHealth(15F).setWittyText(I18nUtil.resolveKey("desc.item.mp_warhead_15_balefire.wittytext")).setUnlocalizedName("mp_warhead_15_balefire").setMaxStackSize(1).setTextureName(RefStrings.MODID + ":mp_warhead");
