...
public class ItemModLens extends ItemArmorMod implements ISatChip {
	...
	public void addInformation(ItemStack itemstack, EntityPlayer player, List list, boolean bool) {
		list.add(EnumChatFormatting.AQUA + I18nUtil.resolveKey("item.sat.desc.frequency") + ": " + this.getFreq(itemstack));
		list.add("");
	...
	public void addDesc(List list, ItemStack stack, ItemStack armor) {
		list.add(I18nUtil.format("desc.item.lens.freq.add", stack.getDisplayName(), getFreq(stack)));
	}
