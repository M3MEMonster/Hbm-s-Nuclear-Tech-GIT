...
public class ItemModLodestone extends ItemArmorMod {
	...
	public void addInformation(ItemStack itemstack, EntityPlayer player, List list, boolean bool) {
		...
		list.add(EnumChatFormatting.DARK_GRAY + I18nUtil.resolveKey("desc.item.lode_stone"));
		list.add(EnumChatFormatting.DARK_GRAY + I18nUtil.format("desc.item.lode_stone.range",range));
		list.add("");
	...
	public void addDesc(List list, ItemStack stack, ItemStack armor) {
		list.add(I18nUtil.format("desc.item.lode_stone.add", stack.getDisplayName(), range));
	}
