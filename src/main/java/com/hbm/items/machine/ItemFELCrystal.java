...
public class ItemFELCrystal extends Item {
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean bool) {
		String desc = (stack.getItem() == ModItems.laser_crystal_digamma) ? (EnumChatFormatting.OBFUSCATED + I18nUtil.resolveKey("desc.item.FELcrystal.digamma")) : (this.getUnlocalizedNameInefficiently(stack) + ".desc");
