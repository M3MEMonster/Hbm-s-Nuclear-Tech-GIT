...
public class ItemDrillbit extends ItemEnumMulti {
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean ext) {
		...
		list.add(EnumChatFormatting.YELLOW + I18nUtil.format("desc.item.drill.speed", ((int) (type.speed * 100))));
		list.add(EnumChatFormatting.YELLOW + I18nUtil.format("desc.item.drill.tier", type.tier));
		if(type.fortune > 0) list.add(EnumChatFormatting.LIGHT_PURPLE + I18nUtil.format("desc.item.drill.fortune", type.fortune));
		if(type.vein) list.add(EnumChatFormatting.GREEN + I18nUtil.resolveKey("desc.item.drill.vein"));
		if(type.silk) list.add(EnumChatFormatting.GREEN + I18nUtil.resolveKey("desc.item.drill.silk"));
	}
