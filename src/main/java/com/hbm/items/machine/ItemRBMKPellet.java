...
public class ItemRBMKPellet extends ItemNuclearWaste {
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean bool) {
		...
		list.add(EnumChatFormatting.DARK_GRAY + "" + EnumChatFormatting.ITALIC + I18nUtil.resolveKey("desc.item.rbmk_pellet.recycle"));

		int meta = rectify(stack.getItemDamage());

		switch(meta % 5) {
		case 0: list.add(EnumChatFormatting.GOLD + I18nUtil.resolveKey("desc.item.rbmk_pellet.new")); break;
		case 1: list.add(EnumChatFormatting.YELLOW + I18nUtil.resolveKey("desc.item.rbmk_pellet.bare_dep")); break;
		case 2: list.add(EnumChatFormatting.GREEN + I18nUtil.resolveKey("desc.item.rbmk_pellet.mod_dep")); break;
		case 3: list.add(EnumChatFormatting.DARK_GREEN + I18nUtil.resolveKey("desc.item.rbmk_pellet.high_dep")); break;
		case 4: list.add(EnumChatFormatting.DARK_GRAY + I18nUtil.resolveKey("desc.item.rbmk_pellet.full_dep")); break;
		}

		if(hasXenon(meta))
			list.add(EnumChatFormatting.DARK_PURPLE + I18nUtil.resolveKey("desc.item.rbmk_pellet.xenon"));
	}
