...
public class ItemFusionShield extends Item {
	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean bool) {
		...
		list.add(I18nUtil.format("desc.item.special.durability",(maxDamage - damage),maxDamage,percent));

		list.add(I18nUtil.format("desc.item.special.fusion_shield.melting_point",maxTemp));
	}
