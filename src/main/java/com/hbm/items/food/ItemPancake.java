...
public class ItemPancake extends ItemFood {
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
    	...
    	if(!world.isRemote)
    		player.addChatComponentMessage(new ChatComponentText(EnumChatFormatting.YELLOW + I18nUtil.resolveKey("chat.item.metal_pancake.too_hard")));
	...
	public void addInformation(ItemStack itemstack, EntityPlayer player, List list, boolean bool) {
		for (String line : I18nUtil.resolveKeyArray("desc.item.metal_pancake")){
			list.add(line);
		}
	}
